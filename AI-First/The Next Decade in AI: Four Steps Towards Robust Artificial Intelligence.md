...
결정적으로 인간의 지식 대신 "일반적인 방법"의 가치에 대한 Sutton의 예는 폐쇄적인 영역에서 온다(게임, 객체 분류, 음성 인식). 반면에 상식은 개방적이다. 바둑과 같은 게임에서 이기는 것은 뉴스를 해석하고 평가하거나 예상치 못한 계획 문제를 실제 세상에서 해결하는 것과는 매우 다르다.
