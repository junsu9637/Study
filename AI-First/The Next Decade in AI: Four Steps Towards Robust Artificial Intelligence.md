...
- 기호는 생물학적으로 타당하지 않다.
  1. 우리가 아직 상징 조절을 지원하는 신경 메커니즘을 결정적으로 식별하지 않았다고 해서 우리가 결코 그렇지 않을 것이라는 것을 의미하지는 않는다. 일부 유명한 신경 기질은 이미 확인되었다. 그리고 다른 문헌들은 이론적으로 그럴듯한 신경 기판을 가리켰다. 어떤 설득력 있는 근거도 그러한 메커니즘이 단순히 뇌와 비슷한 존재가 될 수 없다는 것을 보여준다. 
